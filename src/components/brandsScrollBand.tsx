  ...
  return (
    <div className="w-full py-12 sm:py-16 relative overflow-hidden">
      ...
      <div className="text-center mb-10 relative z-10">
        ...
        <p 
          className="text-sm sm:text-base text-(--ink-72) max-w-2xl mx-auto px-4"
          style={{ fontFamily: "'Inter', sans-serif" }}
        >
          Partnering with exceptional brands to deliver quality packaging solutions
        </p>
      </div>
      ...
      <div className="absolute top-0 left-0 bottom-0 w-32 bg-linear-to-r from-(--background-default) to-transparent pointer-events-none z-20" />
      <div className="absolute top-0 right-0 bottom-0 w-32 bg-linear-to-l from-(--background-default) to-transparent pointer-events-none z-20" />
    </div>
  );
}